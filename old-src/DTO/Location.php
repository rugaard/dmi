...
namespace Rugaard\OldDMI\DTO;

use DateTime;
use DateTimeZone;
use Rugaard\OldDMI\DTO\Forecast\Current;
use Rugaard\OldDMI\DTO\Forecast\Day;
use Rugaard\OldDMI\DTO\Forecast\Hour;
...
class Location extends AbstractDTO
{
    ...
    public function parseWarnings(array $data) : void
    {
        ...
        $this->getHourlyForecast()->transform(function ($hour) use ($hourlyWarnings) {
            /* @var $hour \Rugaard\OldDMI\DTO\Forecast\Hour */
        ...
        $this->getDailyForecast()->transform(function ($day) use ($dailyWarnings) {
            /* @var $day \Rugaard\OldDMI\DTO\Forecast\Day */
     ...
     * Get regional forecast.
     *
     * @return \Rugaard\OldDMI\DTO\Forecast\Text|null
     */
     ...
     *
     * @return \Rugaard\OldDMI\DTO\Forecast\Current|null
     */
