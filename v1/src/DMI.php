...
use Rugaard\DMI\Old\Endpoints\Forecast;
use Rugaard\DMI\Old\Endpoints\Pollen;
use Rugaard\DMI\Old\Endpoints\Search;
use Rugaard\DMI\Old\Endpoints\SeaStations;
use Rugaard\DMI\Old\Endpoints\SunTimes;
use Rugaard\DMI\Old\Endpoints\UV;
use Rugaard\DMI\Old\Endpoints\Warnings;
use Rugaard\DMI\Old\Exceptions\ClientException;
use Rugaard\DMI\Old\Exceptions\DMIException;
use Rugaard\DMI\Old\Exceptions\ParsingFailedException;
use Rugaard\DMI\Old\Exceptions\ServerException;
use Rugaard\DMI\Old\Exceptions\RequestException;
use Rugaard\DMI\Old\Support\Traits\Municipalities;
use Throwable;
...
class DMI
{
     ...
     * @param  string $query
     * @param  int    $limit
     * @return \Rugaard\DMI\Old\Endpoints\Search
     ...
     *
     * @return \Rugaard\DMI\Old\DTO\Forecast\Text
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     * @return \Rugaard\DMI\Old\DTO\Location
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     *
     * @return \Rugaard\DMI\Old\Endpoints\Warnings|null
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     *
     * @param  int|null $id
     * @return \Rugaard\DMI\Old\Endpoints\SunTimes
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     *
     * @param  int|null $id
     * @return \Rugaard\DMI\Old\Endpoints\UV
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     *
     * @return \Rugaard\DMI\Old\Endpoints\Pollen
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     * @return \Rugaard\DMI\Old\Endpoints\SeaStations
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
        ...
        try {
            ...
            if ($withObservations === true || $withForecast === true) {
                ...
                $seaStationIds = $seaStations->getData()->map(function ($seaStation) {
                    /* @var $seaStation \Rugaard\DMI\Old\DTO\SeaStation */
     ...
     * @param  bool $withObservations
     * @param  bool $withForecast
     * @return \Rugaard\DMI\Old\DTO\SeaStation|null
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     * @return \Rugaard\DMI\Old\Endpoints\Archive
     * @throws \Rugaard\DMI\Old\Exceptions\DMIException
     */
     ...
     * @return array
     * @throws \Rugaard\DMI\Old\Exceptions\ParsingFailedException
     */
     ...
     * @return array
     * @throws \Rugaard\DMI\Old\Exceptions\ParsingFailedException
     * @throws \Rugaard\DMI\Old\Exceptions\ServerException
     * @throws \Rugaard\DMI\Old\Exceptions\ClientException
     * @throws \Rugaard\DMI\Old\Exceptions\RequestException
     */
