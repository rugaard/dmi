...
use Rugaard\DMI\DTO\Meteorological\Cloud\Cover as CloudCover;
use Rugaard\DMI\DTO\Meteorological\Cloud\Height as CloudHeight;
use Rugaard\DMI\DTO\Meteorological\Humidity;
use Rugaard\DMI\DTO\Meteorological\LeafMoisture;
use Rugaard\DMI\DTO\Meteorological\Precipitation\Amount as PrecipitationAmount;
use Rugaard\DMI\DTO\Meteorological\Precipitation\Duration as PrecipitationDuration;
use Rugaard\DMI\DTO\Meteorological\Pressure;
use Rugaard\DMI\DTO\Meteorological\Radiation;
use Rugaard\DMI\DTO\Meteorological\Snow\Cover as SnowCover;
use Rugaard\DMI\DTO\Meteorological\Snow\Depth as SnowDepth;
...
use Rugaard\DMI\DTO\Meteorological\Wind\Direction as WindDirection;
use Rugaard\DMI\DTO\Meteorological\Wind\Speed as WindSpeed;
...
enum Parameter: string
{
    ...
    public function dto(): string
    {
        return match ($this) {
            ...
            self::WindGustMax, self::WindGustMaxLatestHour, self::WindGustMaxPrecedingHour => WindSpeed::class,
            self::PrecipitationAmount, self::PrecipitationAmountMinutely, self::PrecipitationAmountHourly, self::PrecipitationAmountDaily => PrecipitationAmount::class,
            self::PrecipitationDuration, self::PrecipitationDurationLatestHour => PrecipitationDuration::class,
            self::SnowDepth => SnowDepth::class,
            self::SnowCover => SnowCover::class,
            self::Visibility, self::VisibilityMean => Visibility::class,
            self::CloudCover => CloudCover::class,
